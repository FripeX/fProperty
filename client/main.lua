        ...
        CreateThread(function()
            while MenuIsOpen do
                RageUI.IsVisible(PropertyActionsMenu, function()
					RageUI.Button("Créer une propriété", false, {}, true, {
						onSelected = function()
							createPropertyType = 1 
						end
					}, PropertyBuilderMenu)
					RageUI.Button("Créer un garage", false, {}, true, {
						onSelected = function()
							createPropertyType = 2
						end
					}, PropertyBuilderMenu)
					RageUI.Button("Gestion des propriété(s)", false, {}, true, {}, PropertyGestionMenu)
					...
					RageUI.Button("Facturer un joueur", false, {}, true, {
                        onSelected = function()
